...
class FinanceManager:
    ...
    def income_window(self):
        ...
        layout = InterfaceStructure(self.data, self.headers, handler.load_categories())
        # Create the Window
        window = sg.Window('My Incomes', layout.income_layout, resizable=True)
        # Event Loop to process
        handler.run_income_window(window, handler.load_categories(),
                                  handler, self.data)
    ...
    def expense_window(self):
        ...
        # Event Loop to process
        handler.run_expense_window(window, handler.load_categories(),
                                   handler, self.data)
    ...
    def main_window(self):
        ...
        # Event Loop to process
        handler.run_main_window(window, handler.load_categories(),
                                self, self.data)
